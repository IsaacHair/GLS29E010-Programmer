...
#define LEN 4 //get correct
#define CHIP 0 
long prog[LEN][6] = 
{
  {0x00, B01000001, 0xff, 0xff, 0x00, 0x01},
  {0x01, B01100001, 0xff, 0xff, 0x00, 0x02},
  {0x02, B10000001, 0xff, 0xff, 0x00, 0x03},
  {0x03, B10100001, 0xff, 0xff, 0x00, 0x00}
};
