...
uint16_t prog[LEN][4]={
    ...
    {0x1000, ADR+0, 0xffff, 0x1001}, //print
    {0x1001, ADR+1, 0x0000, 0x1002},
    {0x1002, JMP+R, 0x0000, 0x1004},
    {0x1004, OUT+1, 0x0000, 0x1010},
    {0x1005, OUT+0, 0x0000, 0x1010},

    {0x1010, ADR+0, 0xffff, 0x1011},
    {0x1011, ADR+1, 0x0001, 0x1012},
    {0x1012, JMP+R, 0x0000, 0x1014},
    {0x1014, OUT+1, 0x0000, 0x1020},
    {0x1015, OUT+0, 0x0000, 0x1020},

    {0x1020, ADR+0, 0xffff, 0x1021},
    {0x1021, ADR+1, 0x0002, 0x1022},
    {0x1022, JMP+R, 0x0000, 0x1024},
    {0x1024, OUT+1, 0x0000, 0x1030},
    {0x1025, OUT+0, 0x0000, 0x1030},

    {0x1030, ADR+0, 0xffff, 0x1031},
    {0x1031, ADR+1, 0x0000, 0x1032},
    {0x1032, JMP+R, 0x0000, 0x1034},
    {0x1034, OUT+1, 0x0000, 0x3000},
    {0x1035, OUT+0, 0x0000, 0x3000},

    {0x3000, OUT+0, 0xfff0, 0x1000}, //fix output
    };
