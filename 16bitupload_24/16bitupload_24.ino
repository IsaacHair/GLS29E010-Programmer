...
uint16_t prog[LEN][4]={
    ...
    {0x5174, ADR+0, 0xffff, 0x51f0},
    {0x5175, ADR+0, 0xffff, 0x51f1},

    {0x5180, ADR+0, 0xffff, 0x5181},
    {0x5181, ADR+1, 0x0000, 0x5182},
    {0x5182, JMP+R, 0x0000, 0x5184},
    {0x5184, ADR+0, 0xffff, 0x51f2},
    {0x5185, ADR+0, 0xffff, 0x51f3},

    {0x5190, ADR+0, 0xffff, 0x5191},
    {0x5191, ADR+1, 0x0000, 0x5192},
    {0x5192, JMP+R, 0x0000, 0x5194},
    {0x5194, ADR+0, 0xffff, 0x51f4},
    {0x5195, ADR+0, 0xffff, 0x51f5},
    
    {0x51a0, ADR+0, 0xffff, 0x51a1},
    {0x51a1, ADR+1, 0x0000, 0x51a2},
    {0x51a2, JMP+R, 0x0000, 0x51a4},
    {0x51a4, ADR+0, 0xffff, 0x51f6},
    {0x51a5, ADR+0, 0xffff, 0x51f7},

    {0x51b0, ADR+0, 0xffff, 0x51b1}, //still 0th digit
    {0x51b1, ADR+1, 0x0000, 0x51b2},
    {0x51b2, JMP+R, 0x0000, 0x51b4},
    {0x51b4, ADR+0, 0xffff, 0x51f8},
    {0x51b5, ADR+0, 0xffff, 0x51f9},

    {0x51c0, ADR+0, 0xffff, 0x51c1},
    {0x51c1, ADR+1, 0x0000, 0x51c2},
    {0x51c2, JMP+R, 0x0000, 0x51c4},
    {0x51c4, ADR+0, 0xffff, 0x51fa},
    {0x51c5, ADR+0, 0xffff, 0x51fb},

    {0x51d0, ADR+0, 0xffff, 0x51d1},
    {0x51d1, ADR+1, 0x0000, 0x51d2},
    {0x51d2, JMP+R, 0x0000, 0x51d4},
    {0x51d4, ADR+0, 0xffff, 0x51fc},
    {0x51d5, ADR+0, 0xffff, 0x51fd},

    {0x51e0, ADR+0, 0xffff, 0x51e1},
    {0x51e1, ADR+1, 0x0000, 0x51e2},
    {0x51e2, JMP+R, 0x0000, 0x51e4},
    {0x51e4, ADR+0, 0xffff, 0x51fe},
    {0x51e5, ADR+0, 0xffff, 0x51ff},


    {0x51f0, OUT+0, 0x0001, 0x1000}, //actually print it
    {0x51f1, OUT+0, 0x0002, 0x1000},
    {0x51f2, OUT+0, 0x0004, 0x1000},
    {0x51f3, OUT+0, 0x0008, 0x1000},
    {0x51f4, OUT+0, 0x0010, 0x1000},
    {0x51f5, OUT+0, 0x0020, 0x1000},
    {0x51f6, OUT+0, 0x0040, 0x1000},
    {0x51f7, OUT+0, 0x0080, 0x1000},

    {0x51f8, OUT+0, 0x0100, 0x1000},
    {0x51f9, OUT+0, 0x0200, 0x1000},
    {0x51fa, OUT+0, 0x0400, 0x1000},
    {0x51fb, OUT+0, 0x0800, 0x1000},
    {0x51fc, OUT+0, 0x1000, 0x1000},
    {0x51fd, OUT+0, 0x2000, 0x1000},
    {0x51fe, OUT+0, 0x4000, 0x1000},
    {0x51ff, OUT+0, 0x8000, 0x1000},
    ...
    {0x5274, ADR+0, 0xffff, 0x52f0},
    {0x5275, ADR+0, 0xffff, 0x52f1},

    {0x5280, ADR+0, 0xffff, 0x5281},
    {0x5281, ADR+1, 0x0000, 0x5282},
    {0x5282, JMP+R, 0x0000, 0x5284},
    {0x5284, ADR+0, 0xffff, 0x52f2},
    {0x5285, ADR+0, 0xffff, 0x52f3},

    {0x5290, ADR+0, 0xffff, 0x5291},
    {0x5291, ADR+1, 0x0000, 0x5292},
    {0x5292, JMP+R, 0x0000, 0x5294},
    {0x5294, ADR+0, 0xffff, 0x52f4},
    {0x5295, ADR+0, 0xffff, 0x52f5},
   
    {0x52a0, ADR+0, 0xffff, 0x52a1},
    {0x52a1, ADR+1, 0x0000, 0x52a2},
    {0x52a2, JMP+R, 0x0000, 0x52a4},
    {0x52a4, ADR+0, 0xffff, 0x52f6},
    {0x52a5, ADR+0, 0xffff, 0x52f7},

    {0x52b0, ADR+0, 0xffff, 0x52b1}, //still 0th digit
    {0x52b1, ADR+1, 0x0000, 0x52b2},
    {0x52b2, JMP+R, 0x0000, 0x52b4},
    {0x52b4, ADR+0, 0xffff, 0x52f8},
    {0x52b5, ADR+0, 0xffff, 0x52f9},
    
    {0x52c0, ADR+0, 0xffff, 0x52c1},
    {0x52c1, ADR+1, 0x0000, 0x52c2},
    {0x52c2, JMP+R, 0x0000, 0x52c4},
    {0x52c4, ADR+0, 0xffff, 0x52fa},
    {0x52c5, ADR+0, 0xffff, 0x52fb},

    {0x52d0, ADR+0, 0xffff, 0x52d1},
    {0x52d1, ADR+1, 0x0000, 0x52d2},
    {0x52d2, JMP+R, 0x0000, 0x52d4},
    {0x52d4, ADR+0, 0xffff, 0x52fc},
    {0x52d5, ADR+0, 0xffff, 0x52fd},

    {0x52e0, ADR+0, 0xffff, 0x52e1},
    {0x52e1, ADR+1, 0x0000, 0x52e2},
    {0x52e2, JMP+R, 0x0000, 0x52e4},
    {0x52e4, ADR+0, 0xffff, 0x52fe},
    {0x52e5, ADR+0, 0xffff, 0x52ff},


    {0x52f0, OUT+1, 0x0001, 0x0000}, //actually print it
    {0x52f1, OUT+1, 0x0002, 0x0000},
    {0x52f2, OUT+1, 0x0004, 0x0000},
    {0x52f3, OUT+1, 0x0008, 0x0000},
    {0x52f4, OUT+1, 0x0010, 0x0000},
    {0x52f5, OUT+1, 0x0020, 0x0000},
    {0x52f6, OUT+1, 0x0040, 0x0000},
    {0x52f7, OUT+1, 0x0080, 0x0000},

    {0x52f8, OUT+1, 0x0100, 0x0000},
    {0x52f9, OUT+1, 0x0200, 0x0000},
    {0x52fa, OUT+1, 0x0400, 0x0000},
    {0x52fb, OUT+1, 0x0800, 0x0000},
    {0x52fc, OUT+1, 0x1000, 0x0000},
    {0x52fd, OUT+1, 0x2000, 0x0000},
    {0x52fe, OUT+1, 0x4000, 0x0000},
    {0x52ff, OUT+1, 0x8000, 0x0000},
    };
