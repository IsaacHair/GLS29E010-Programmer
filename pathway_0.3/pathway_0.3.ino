  #define LEN 443 //********make sure to get length correct
 #define JMP 0
 #define OUT 2
 #define ADR 4
 #define BUF 6
...
uint16_t prog[LEN][4]={
    ...
    {0x540f, OUT+0, 0x8000, 0x0000}, //equalizes clock cycles spent to add 1 to number
    ...
    {0x6001, ADR+1, 0x2000, 0x6002}, //delaying to equalize so that in total each increment takes 2236 instructions
